            ...
            <div class="col-md-6 offset-md-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text"><span class="fw-bold">Full Name:</span> {{ $new_attendee->fname }}
                            {{ $new_attendee->lname }}</p>
                        <p class="card-text"><span class="fw-bold">Occupational Status:</span>
                            {{ $new_attendee->occupational_status }}</p>
                        <p class="card-text"><span class="fw-bold">School Name:
                            </span>{{ $new_attendee->school_name ?: 'N/A' }}</p>
                        <p class="card-text"><span class="fw-bold">Employer:</span> {{ $new_attendee->employer ?: 'N/A' }}
                        </p>
                        <p class="card-text"><span class="fw-bold">Work Specialization:</span>
                            {{ $new_attendee->work_specialization ?: 'N/A' }}</p>
